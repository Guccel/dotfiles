...
vim.api.nvim_create_user_command('PeekOpen', function()
  if not peek.is_open() and vim.bo[vim.api.nvim_get_current_buf()].filetype == 'markdown' then
    ...
    vim.fn.system('i3-msg resize shrink width 50 px')
    peek.open()
  end
end, {})
...
vim.keymap.set({'n', 'v'}, '<leader>x', ':x<cr>', { silent = true })
...
-- [[ Configure CHADtree ]]
vim.keymap.set({'n', 'v'}, '<leader>\\', '<cmd>CHADopen<cr>', { silent = true })
...
vim.keymap.set('n', '<leader>P', '<cmd>BufferClose<cr>', { silent = true })
